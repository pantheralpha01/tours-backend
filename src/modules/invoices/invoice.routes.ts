 ...
 */
invoiceRoutes.post("/", authenticate, invoiceController.create);
 ...
 */
invoiceRoutes.get("/", authenticate, invoiceController.list);
 ...
 *                   $ref: '#/components/schemas/Pagination'
 */
invoiceRoutes.get("/booking/:bookingId", authenticate, invoiceController.getByBookingId);
 ...
 */
invoiceRoutes.get("/:id", authenticate, invoiceController.getById);
 ...
 *         description: Invoice not found
 */
invoiceRoutes.patch("/:id/send", authenticate, invoiceController.send);
 ...
 *         description: Invoice not found
 */
invoiceRoutes.patch("/:id/status", authenticate, invoiceController.updateStatus);
 ...
 */
invoiceRoutes.post("/:id/payments", authenticate, invoiceController.recordPayment);
 ...
 *         description: Invoice not found
 */
invoiceRoutes.get("/:id/transactions", authenticate, invoiceController.getTransactions);
 ...
 *         description: Invoice not found
 */
invoiceRoutes.delete("/:id", authenticate, invoiceController.delete);
