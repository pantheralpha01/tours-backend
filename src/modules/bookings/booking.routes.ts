...
bookingRoutes.use(requireRoles("ADMIN", "MANAGER", "AGENT"));
 ...
 *               $ref: '#/components/schemas/PaginatedResponse'
 */
bookingRoutes.get("/calendar", bookingController.calendar);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
bookingRoutes.put("/:id/transition", bookingController.transition);
