...
export const config = {
  ...
  escrowScheduler: {
    ...
    intervalMs: Number(process.env.ESCROW_SCHEDULER_INTERVAL_MS ?? 60_000),
  ...
  notificationScheduler: {
    ...
    intervalMs: Number(process.env.NOTIFICATION_SCHEDULER_INTERVAL_MS ?? 60_000),
  ...
  community: {
    ...
    digestScheduler: {
      ...
      intervalMs: Number(process.env.COMMUNITY_DIGEST_SCHEDULER_INTERVAL_MS ?? 86_400_000),
